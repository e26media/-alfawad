...
const OverviewSidebar = () => {
  ...
  const OVERVIEW_LINKS = [
    { label: isAr ? "مقدمة" : "INTRODUCTION", path: "/industrial/introduction" },
    { label: isAr ? "رسالة رئيس مجلس الإدارة" : "CHAIRMAN MESSAGE", path: "/industrial/chairman-message" },
    { label: isAr ? "رسالة المدير التنفيذي" : "CEO MESSAGE", path: "/industrial/ceo-message" },
    { label: isAr ? "الرؤية والرسالة" : "VISION & MISSION", path: "/industrial/vision-mission" },
    { label: isAr ? "سياسة الجودة" : "QUALITY POLICY", path: "/industrial/quality-policy" },
    { label: isAr ? "سياسة البيئة والسلامة" : "ENVIRONMENT & SAFETY POLICY", path: "/industrial/environment-safety" },
  ];
    ...
    <div className="w-full lg:w-1/3 xl:w-1/4">
      ...
      <div className="bg-white shadow-xl border border-gray-100 overflow-hidden mb-8 ">
        <h3 className="bg-[#1c1c1c] text-white font-black uppercase text-[18px] px-8 py-5 flex items-center justify-between tracking-tighter">
          {isAr ? "نظرة عامة" : "Overview"} <div className="w-2.5 h-2.5 rounded-full bg-alfawad-primary" />
        </h3>
