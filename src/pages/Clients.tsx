        ...
        <AnimatedSection>
          <div className="flex flex-col items-center text-center mb-24">
             ...
             <p className="text-gray-500 text-lg font-medium leading-relaxed max-w-3xl">
               At Lamiya Al Kahleej Company, our success is measured by customer satisfaction. We proudly serve a wide range of clients, including residential customers and leading commercial businesses across the Kingdom.
             </p>
          </div>
        </AnimatedSection>
