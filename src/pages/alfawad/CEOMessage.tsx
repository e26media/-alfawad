        ...
        <div className="container mx-auto px-4 lg:px-12 max-w-[1400px] relative z-20 flex flex-col items-center justify-center text-center pt-32 md:pt-48">
          <div className="w-full text-white">
            ...
            <div className="flex items-center justify-center gap-3 text-[14px] md:text-[16px] font-black text-white/95 uppercase tracking-[0.2em]">
              <Link to="/industrial" className="hover:text-alfawad-accent transition-all duration-300">Home</Link>
              <ChevronRight className="w-4 h-4 text-white/50" />
              <span className="text-white/70">Overview</span>
              <ChevronRight className="w-4 h-4 text-white/50" />
              <span className="text-white">CEO Message</span>
            </div>
          </div>
        </div>
      </section>
              ...
              <div className="bg-white p-8 md:p-16 shadow-xl border border-gray-100 relative overflow-hidden group">
                ...
                <div className="flex flex-col gap-12">
                  <div className="flex flex-col border-l-8 border-alfawad-primary pl-8">
                    <span className="text-alfawad-primary font-black text-[14px] uppercase tracking-[0.4em] mb-2">Our Visionary Leadership</span>
                    ...
                    <div className="w-full flex flex-col gap-12 relative">
                      ...
                      <div className="relative z-10">
                        <p className="text-[24px] md:text-[32px] font-black text-black leading-tight italic mb-12 tracking-tighter">
                          "At Lamiya Al Khaleej, we strive for operational excellence and strategic growth, ensuring every project meets the highest standards of safety and quality."
                        </p>

                        <div className="text-[#666666] leading-[36px] text-[18px] font-medium flex flex-col gap-8 max-w-4xl">
                          <p>
                            It is my privilege to lead such a dedicated team at Lamiya Al Khaleej Al Ittehad. Our journey has been defined by our ability to adapt to the changing needs of the industrial sector while never compromising on our core values.
                          </p>
                          <p>
                            We focus on operational efficiency and the deployment of advanced technical manpower and equipment. By prioritizing local talent development and international best practices, we aim to be the most trusted partner for major industrial players in the Kingdom.
                          </p>
                          <p>
                            Our success is measured by the satisfaction of our clients and the safety of our workforce. We are committed to playing a significant role in the Kingdom's Vision 2030 by delivering world-class contracting services and fostering sustainable industrial growth.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="mt-12 pt-12 border-t border-gray-100 w-full flex flex-col md:flex-row justify-between items-end gap-8">
                        <div className="flex flex-col gap-1">
                          <div className="text-[28px] font-black uppercase tracking-tighter text-black leading-none">Mohammed Nouman Hussain</div>
                          <div className="text-alfawad-primary font-black uppercase tracking-widest text-[12px] mt-2">Chief Executive Officer</div>
                          <div className="text-gray-400 font-bold uppercase tracking-widest text-[10px]">Lamiya alkhaleej alittihad establishment for general contracting</div>
                        </div>
