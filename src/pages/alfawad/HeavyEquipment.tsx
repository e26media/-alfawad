              ...
              <div className="bg-white p-8 md:p-16 shadow-xl border border-gray-100 relative overflow-hidden group">
                ...
                <div className="flex flex-col gap-8">
                  ...
                  <div className="text-[#666666] leading-[36px] text-[18px] font-medium flex flex-col gap-6">
                    <p>
                      Lamiya Al Khaleej Al Ittehad  General Contracting provides reliable equipment rental solutions with a focus on machine performance and operator safety. All our equipment units are well-maintained and comply with industrial safety standards, ensuring smooth operations on-site.
                    </p>
                    <p>
