        ...
        <div className="container mx-auto px-4 lg:px-12 max-w-[1400px] relative z-20 flex flex-col items-center justify-center text-center pt-20">
           <div className="w-full text-white">
              ...
              <div className="flex items-center justify-center gap-3 text-[14px] md:text-[16px] font-black text-white/95 uppercase tracking-[0.2em]">
                ...
                <ChevronRight className="w-4 h-4 text-white/50" />
                <span className="text-white">Heavy Equipment</span>
              </div>
           </div>
        </div>
      </section>
              ...
              <div className="bg-white p-8 md:p-16 shadow-xl border border-gray-100 relative overflow-hidden group">
                 ...
                 <div className="flex flex-col gap-8">
                   ...
                   <p className="text-[20px] md:text-[22px] font-bold text-black leading-relaxed italic border-b border-gray-100 pb-8">
                     Our establishment owns and operates a comprehensive range of construction machinery to support large-scale industrial projects.
                   </p>

                   <div className="text-[#666666] leading-[36px] text-[18px] font-medium flex flex-col gap-6">
                     <p>
                       Al Fawad operates its heavy equipment fleet directly, ensuring that every machine is maintained to the highest operational standards. All our equipment is supplied with certified operators who are trained in the rigorous safety protocols required by industrial sites like Saudi Aramco and SABIC.
                     </p>
                     <p>
                       Our logistics and rental service covers everything from light transport to heavy-lifting cranes, providing flexible rental terms ranging from daily hire to long-term project leases.
                     </p>
                   </div>
                   ...
                   <div className="bg-black p-12 mt-4 relative overflow-hidden group">
                      ...
                      <h3 className="text-2xl font-black text-white uppercase mb-8 border-l-4 border-alfawad-primary pl-6 tracking-tighter">Fleet Capabilities</h3>
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-4">
                     {[
                       { title: "24/7 Support", icon: <Zap className="w-8 h-8" />, desc: "Mobilize on-site maintenance teams to minimize project downtime." },
                       { title: "TUV Certified", icon: <ShieldCheck className="w-8 h-8" />, desc: "All machines carry valid third-party safety and operational certificates." },
                       { title: "Fleet Tracking", icon: <Activity className="w-8 h-8" />, desc: "Real-time monitoring and reporting for equipment utilization." }
                     ].map((item, i) => (
                       <div key={i} className="bg-gray-50 p-8 border-b-4 border-alfawad-primary flex flex-col gap-4 text-center items-center group hover:bg-black transition-all duration-500">
