              ...
              <div className="bg-white p-8 md:p-16 shadow-xl border border-gray-100 relative overflow-hidden group">
                ...
                <div className="flex flex-col gap-8">
                  ...
                  <p className="text-[20px] md:text-[22px] font-bold text-black leading-relaxed italic border-b border-gray-100 pb-8">
                    {isAr ? "نقدم في لمياء الخليج خدمات إدارة المشاريع والإشراف المهني لضمان الانتهاء منها بكفاءة وأمان." : "At Lamiya Al Khaleej Al Ittehad  General Contracting, we offer professional project management and site supervision services to ensure that every project is completed with efficiency, safety, and quality."}
                  </p>
