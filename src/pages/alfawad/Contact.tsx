                ...
                <form className="flex flex-col gap-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex flex-col gap-2">
                      ...
                      <input type="tel" placeholder="+966 5X XXX XXXX" className="w-full bg-gray-50 border border-gray-200 rounded px-4 py-3 focus:outline-none focus:border-alfawad-primary focus:ring-1 focus:ring-alfawad-primary transition-colors" />
                    </div>
                    <div className="flex flex-col gap-2">
