...
const Services = () => (
  <div className="pt-32 md:pt-40 font-muli bg-white overflow-x-hidden">
    <SEO 
      title="Our Services | Lamiya Al Kahleej Company - Cleaning & Maintenance in KSA" 
      description="At Lamiya Al Kahleej Company, we offer a wide range of professional services designed for both residential and commercial customers. Complete cleaning & maintenance solutions in KSA."
    />
